...
export default function FichaPersonagemPage() {
  ...
  return (
    <main className={`min-h-screen w-full bg-[#090e17] text-[#8b9bb4] relative pb-32 ${inter.className} selection:bg-[#4ad9d9]/30 selection:text-white`}>
        ...
        {isOP ? (
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div className="xl:col-span-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-[#131b26]/60 p-6 rounded-2xl border border-[#2a3b52] shadow-xl">
                ...
                <div className="space-y-5">
                  {[
                    ...
                    { key: 'sanidade', label: 'SANIDADE', color: 'bg-purple-600', fill: '#a855f7' }, // Mantendo a Sanidade na cor do sistema (roxa), mas adaptada ao tema escuro
                    { key: 'estamina', label: 'ESFORÇO', color: 'bg-yellow-500', fill: '#eab308' } // Esforço/PE em amarelo/laranja
                  ].map(s => {
              ...
              {/* MENU DE ABAS - AETHERQUEST STYLE */}
              ...
              <div className="py-2">
                ...
                {/* ABA: HABILIDADES, RITUAIS, PARANORMAL */}
      ...
      <style jsx global>{`
        /* Scrollbar customizada azul (AetherQuest theme) */
