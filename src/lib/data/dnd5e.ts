export const DND5E = {
  ...
  origens: [
    {
      nome: "Acolito",
      desc: "Ligacao com templos e tradicao.",
      proficiencias: ["Religiao", "Intuicao"],
    },
    {
      nome: "Criminoso",
      desc: "Furtividade e contatos.",
      proficiencias: ["Crime", "Furtividade"],
    },
    {
      nome: "Erudito",
      desc: "Conhecimento academico.",
      proficiencias: ["Historia", "Atualidades"],
    },
    {
      nome: "Heroi do Povo",
      desc: "Figura querida pelo povo.",
      proficiencias: ["Atletismo", "Sobrevivencia"],
    },
    {
      nome: "Soldado",
      desc: "Disciplina e experiencia de combate.",
      proficiencias: ["Intimidacao", "Tatica"],
    },
    {
      nome: "Personalizada",
      custom: true,
      desc: "Defina um antecedente proprio.",
    },
  ],
  classes: [
    {
    ...
    },
    {
      nome: "Personalizada",
      custom: true,
      desc: "Defina uma classe propria.",
    },
  ],
  categorias_hab: [
  ...
  racas_hab: [
    ...
    { nome: "Sentidos Aguçados", dado: "-", desc: "Percepcao superior e elegancia natural.", subcat: "Elfo", fonte: "D&D 5e" },
