...
export default function TokenPanel({ token, fichaData, salaId, onClose, onTokenUpdate }: TokenPanelProps) {
  ...
  return (
    <div
      className="fixed inset-x-3 bottom-[86px] z-50 max-h-[58svh] overflow-hidden rounded-[0.9rem] lg:inset-x-auto lg:bottom-auto lg:right-4 lg:top-1/2 lg:w-72 lg:-translate-y-1/2"
      style={{
    ...
    >
      ...
      <div className="aq-scrollbar max-h-[calc(58svh-70px)] space-y-4 overflow-y-auto p-4 lg:max-h-[calc(70vh-80px)]">
        <div>
